...
LightwaveRF.prototype.getConfiguration = function(email,pin,manager_host,callback){
    ...
    var post_req = https.request(post_options, function(res) {
     ...
     res.on('end', function () {
            ...
            if(indexRoomsStart < 0) {this.log('gRoomNames not found'); return;}
            ...
            if(indexDevicesStart < 0) {this.log('gDeviceNames not found'); return;}
            ...
            if(indexTypesStart < 0) {this.log('gDeviceStatus not found'); return;}
